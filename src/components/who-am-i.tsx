...
export default function WhoAmI() {
  const skills = [
    // Row 1: TypeScript, Python, Vim, React
    { 
      name: "TypeScript", 
      category: "Language",
      icon: (
        <svg role="img" viewBox="0 0 24 24" className="w-8 h-8" fill="black">
    ...
    // Row 2: OpenAI API, Ollama, Git, Docker
    { 
      name: "OpenAI API", 
      category: "AI",
      icon: (
    ...
    // Row 3: PostgreSQL, Go, Node.js, FastAPI
    { 
      name: "PostgreSQL", 
      category: "Database",
      icon: (
